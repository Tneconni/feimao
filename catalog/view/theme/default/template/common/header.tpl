...
<div class="header ie6fixedTL">
    <div class="header_top clearfix">
        ...
        <ul class="top_menur jvf_fr clearfix">
            ...
            <?php } ?>
            <li><a href="index.php?route=information/information&information_id=8">人力资源</a></li>
    ...
    <div class="header_con clearfix">
        ...
        <div class="jvf_fl header_con_menu">
            <ul>
                ...
                <li ><a href='index.php?route=information/information&information_id=7'>打印机</a></li>
                <li ><a href='#'>创意产品</a></li>
                <li ><a href="<?php echo $printer; ?>" >3D商城</a></li>
