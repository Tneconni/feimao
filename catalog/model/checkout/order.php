...
class ModelCheckoutOrder extends Model {
    public function addOrder($data) {
        ...
        foreach ($data['products'] as $product) {
            ...
            if(!empty($product['threedoption'])) {

                if(is_array($product['threedoption'])) {
                    $optionStr = implode(',',$product['threedoption']);
                }else{
                    $optionStr = $product['threedoption'];
                }

                $this->db->query("INSERT INTO " . DB_PREFIX . "order_to_threedoption SET order_product_id = '" . (int)$order_product_id . "', `option` = '" . $optionStr . "'");
