...
class ModelAccountCustomer extends Model {
	public function addCustomer($data) {
		...
		nick_name = '" . $this->db->escape($data['nick_name']) . "',
		account = '" . $this->db->escape($data['account']) . "',
		payment_psd = '" . $this->db->escape($data['payment_psd']) . "',
    ...
    public function getCustomerByAccount($account) {
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "customer WHERE LOWER(account) = '" . $this->db->escape(utf8_strtolower($account)) . "'");
    ...
    public function getTotalCustomersByAccount( $account ) {
        $query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "customer
		 WHERE LOWER(account) = '" . $this->db->escape(utf8_strtolower( $account )) . "'");
