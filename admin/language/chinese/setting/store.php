...
// Entry
$_['entry_url']                 = '网站网址：<br /><span class="help">请输入你网站的完整网址。 注意在最后加上 \'/\' 。 例： http：//www.yourdomain.com/path/<br /><br />请用新的域名或二级域名指定到你的主机。</span>';
$_['entry_ssl']                 = '使用 SSL：<br /><span class="help">要使用SSL， 您需要在您的服务安装SSL及在设定档有SSL凭证。</span>';
$_['entry_name']                = '网站名称：';
$_['entry_owner']               = '网站管理员：';
$_['entry_address']             = '网站地址：';
$_['entry_email']               = '邮件地址：';
...
$_['entry_tax']                 = '显示含税价：';
$_['entry_tax_default']         = '使用3D打印平台所在地税率：<br /><span class="help">非注册会员使用3D打印平台所在地税率。 你可以使用3D打印平台所在地税率计算税费。</span>';
$_['entry_tax_customer']        = '使用会员所在地税率：<br /><span class="help">注册会员使用会员所在地税率。 你可以使用3D打印平台所在地税率计算税费。</span>';
...
$_['error_owner']               = '3D打印平台拥有者必须在3至64个字符之间！';
$_['error_address']             = '网站地址必须在10 到256个字符！';
...
$_['error_default']             = '警告： 您不能删除默认网站！';
$_['error_store']               = '警告： 本网站不能被删除，因为目前它被绑定到%s订单！';
